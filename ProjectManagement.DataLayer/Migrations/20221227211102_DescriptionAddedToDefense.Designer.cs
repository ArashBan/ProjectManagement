...
namespace ProjectManagement.DataLayer.Migrations
{
    ...
    [Migration("20221227211102_DescriptionAddedToDefense")]
    partial class DescriptionAddedToDefense
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManagement.DataLayer.Entities.Account.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2022, 12, 28, 0, 41, 2, 730, DateTimeKind.Local).AddTicks(7966),
                            IsDeleted = false,
                            Name = "دانشجو"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2022, 12, 28, 0, 41, 2, 730, DateTimeKind.Local).AddTicks(7976),
                            IsDeleted = false,
                            Name = "استاد"
                        });
                });
            ...
            modelBuilder.Entity("ProjectManagement.DataLayer.Entities.Common.News", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectManagement.DataLayer.Entities.Common.Problem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectManagement.DataLayer.Entities.Courses.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2022, 12, 28, 0, 41, 2, 728, DateTimeKind.Local).AddTicks(8995),
                            IsDeleted = false,
                            Name = "پروژه",
                            Unit = (byte)2
                        },
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTime(2022, 12, 28, 0, 41, 2, 728, DateTimeKind.Local).AddTicks(9020),
                            IsDeleted = false,
                            Name = "کارآموزی",
                            Unit = (byte)2
                        });
            ...
            modelBuilder.Entity("ProjectManagement.DataLayer.Entities.Courses.InternshipReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InternshipReports", "dbo");
                });

            modelBuilder.Entity("ProjectManagement.DataLayer.Entities.Courses.InternshipRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DaysOfAttendance")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PlacePhoneNumber")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("InternshipRequests", "dbo");
                });

            modelBuilder.Entity("ProjectManagement.DataLayer.Entities.Courses.ProjectDefenseRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProjectDefenseRequests", "dbo");
                });
            ...
            modelBuilder.Entity("ProjectManagement.DataLayer.Entities.Courses.ProjectProgress", b =>
                {
                    ...
                    b.ToTable("ProjectProgresses", "dbo");
                });
            ...
            modelBuilder.Entity("ProjectManagement.DataLayer.Entities.Courses.InternshipReport", b =>
                {
                    b.HasOne("ProjectManagement.DataLayer.Entities.Courses.InternshipRequest", "Internship")
                        .WithMany("InternshipReports")
            ...
            modelBuilder.Entity("ProjectManagement.DataLayer.Entities.Courses.InternshipRequest", b =>
                {
                    b.Navigation("InternshipReports");
                });

            modelBuilder.Entity("ProjectManagement.DataLayer.Entities.Courses.ProjectRequest", b =>
                {
                    b.Navigation("DefenseRequests");
